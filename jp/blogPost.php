...
<?php
    ...
    ?>
            ...
            for ($i = 3; $i <= 8; $i++) {
                if (!empty($row['para'.$i]) && !empty($row['image'.$i])) {
                    echo "<div class='row blogspot' style='margin-top:50px;padding-bottom:40px; margin:50px;'>
                            <div>
                                <div style='padding:0px 0px 0px 0px;float:right; margin-left:10px' class='col-lg-6 order-lg-1 image{$i}'>
                                    <div class='blog-image'>
                                        <img style='width:1000px;' class='col para1-image' src='admin/{$row['image'.$i]}' alt='Card image cap'>
                                    </div>
                                </div>
                                <div class='order-lg-2 title'>
                                    <div class='blog-post col'>
                                        <p>
                                            <span class='frontline'>{$title}&nbsp;</span>{$row['para'.$i]}
                                        </p>
                                    </div>
                                </div>
                            </div>
