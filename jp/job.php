...
// header('location:https://minha.com')
?>
...
if (isset($_GET['J_id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        ?>
<!-- HOME -->
<section class="section-hero overlay inner-page bg-image" style="background-image: url('<?php echo $row['jobImage']; ?>'); background-size: cover;" id="home-section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
